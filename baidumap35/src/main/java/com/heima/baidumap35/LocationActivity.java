...
public class LocationActivity extends BaseMapActivity{
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            Log.e("map", location.getAddress() + "," + location.getAddrStr());
            // 开启定位图层
            ...
            overlayOptions.icon(mCurrentMarker);
            overlayOptions.position(new LatLng(location.getLatitude(), location.getLongitude()));
